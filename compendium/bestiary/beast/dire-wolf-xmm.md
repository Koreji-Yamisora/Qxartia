...
![](compendium/bestiary/beast/token/dire-wolf-xmm.webp#token)
...
***Bite.*** *Melee Attack Roll:* +5, reach 5 ft. *Hit:* 8 (1d10 + 3) Piercing damage. If the target is a Large or smaller creature, it has the [Prone](compendium/rules/conditions.md#Prone) condition.
^statblock
