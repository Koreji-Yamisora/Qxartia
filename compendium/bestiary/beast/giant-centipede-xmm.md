...
![](compendium/bestiary/beast/token/giant-centipede-xmm.webp#token)
...
***Bite.*** *Melee Attack Roll:* +4, reach 5 ft. *Hit:* 4 (1d4 + 2) Piercing damage, and the target has the [Poisoned](compendium/rules/conditions.md#Poisoned) condition until the start of the centipede's next turn.
^statblock
