...
![](compendium/bestiary/beast/token/giant-seahorse-xmm.webp#token)
...
***Bubble Dash.*** While underwater, the seahorse moves up to half its [Swim Speed](compendium/rules/variant-rules/swim-speed-xphb.md) without provoking [Opportunity Attacks](compendium/rules/actions.md#Opportunity%20Attack).
^statblock
