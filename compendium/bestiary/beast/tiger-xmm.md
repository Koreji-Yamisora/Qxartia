...
![](compendium/bestiary/beast/token/tiger-xmm.webp#token)
...
***Rend.*** *Melee Attack Roll:* +5, reach 5 ft. *Hit:* 10 (2d6 + 3) Slashing damage. If the target is a Large or smaller creature, it has the [Prone](compendium/rules/conditions.md#Prone) condition.
