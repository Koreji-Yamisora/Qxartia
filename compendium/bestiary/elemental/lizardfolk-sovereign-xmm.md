...
![](compendium/bestiary/elemental/token/lizardfolk-sovereign-xmm.webp#token)
...
***Bite.*** *Melee Attack Roll:* +5, reach 5 ft. *Hit:* 8 (1d10 + 3) Piercing damage. If the target is a creature that isn't a Construct or an Undead, the lizardfolk gains [Temporary Hit Points](compendium/rules/variant-rules/temporary-hit-points-xphb.md) equal to the damage dealt.

***Earthen Maul.*** *Melee Attack Roll:* +5, reach 5 ft. *Hit:* 10 (2d6 + 3) Bludgeoning damage. If the target is a Medium or smaller creature, it has the [Prone](compendium/rules/conditions.md#Prone) condition.

## Bonus Actions

***Charge.*** The lizardfolk moves up to its [Speed](compendium/rules/variant-rules/speed-xphb.md) or [Swim Speed](compendium/rules/variant-rules/swim-speed-xphb.md) straight toward an enemy it can see.
^statblock
