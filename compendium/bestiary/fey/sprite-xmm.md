...
![](compendium/bestiary/fey/token/sprite-xmm.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Perception](compendium/rules/skills.md#Perception) +3, [Stealth](compendium/rules/skills.md#Stealth) +8
...
***Enchanting Bow.*** *Ranged Attack Roll:* +6, range 40/160 ft. *Hit:* 1 Piercing damage, and the target has the [Charmed](compendium/rules/conditions.md#Charmed) condition until the start of the sprite's next turn.
