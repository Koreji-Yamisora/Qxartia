...
![](compendium/bestiary/giant/token/cloud-giant-xmm.webp#token)
*Huge giant, Neutral*
...
- **Skills** [Insight](compendium/rules/skills.md#Insight) +7, [Perception](compendium/rules/skills.md#Perception) +11
...
***Thundercloud.*** *Ranged Attack Roll:* +12, range 240 ft. *Hit:* 18 (3d6 + 8) Thunder damage, and the target has the [Incapacitated](compendium/rules/conditions.md#Incapacitated) condition until the end of its next turn.
