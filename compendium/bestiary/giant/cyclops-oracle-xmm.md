...
![](compendium/bestiary/giant/token/cyclops-oracle-xmm.webp#token)
...
- **Skills** [History](compendium/rules/skills.md#History) +11, [Perception](compendium/rules/skills.md#Perception) +12
- **Senses** [Truesight](compendium/rules/senses.md#Truesight) 30 ft., passive Perception 22
- **Languages** Giant
- **Challenge** 10
...
***Flash of Light.*** *Ranged Attack Roll:* +10, range 120 ft. *Hit:* 17 (2d10 + 6) Radiant damage, and the target has [Disadvantage](compendium/rules/variant-rules/disadvantage-xphb.md) on attack rolls until the end of the cyclops's next turn.
...
**2/day each:** [Arcane Eye](compendium/spells/arcane-eye-xphb.md), [Detect Magic](compendium/spells/detect-magic-xphb.md), [Locate Object](compendium/spells/locate-object-xphb.md)

**1/day:** [Legend Lore](compendium/spells/legend-lore-xphb.md)

## Reactions

***Portent (Recharge 4-6).*** Trigger: The cyclops or an ally it can see makes a [D20 Test](compendium/rules/variant-rules/d20-test-xphb.md). _Response:_ The cyclops rolls 1d20 and chooses whether to use that roll in place of the d20 rolled for the [D20 Test](compendium/rules/variant-rules/d20-test-xphb.md).
^statblock
