...
![](compendium/bestiary/giant/token/fire-giant-xmm.webp#token)
...
- **Skills** [Athletics](compendium/rules/skills.md#Athletics) +11, [Perception](compendium/rules/skills.md#Perception) +6
...
***Hammer Throw.*** *Ranged Attack Roll:* +11, range 60/240 ft. *Hit:* 23 (3d10 + 7) Bludgeoning damage plus 4 (1d8) Fire damage, and the target is pushed up to 15 feet straight away from the giant and has [Disadvantage](compendium/rules/variant-rules/disadvantage-xphb.md) on the next attack roll it makes before the end of its next turn.
^statblock
