...
![](compendium/bestiary/humanoid/token/gladiator-xmm.webp#token)
...
- **Skills** [Athletics](compendium/rules/skills.md#Athletics) +10, [Performance](compendium/rules/skills.md#Performance) +5
- **Senses** passive Perception 11
- **Gear** [shield](compendium/items/shield-xphb.md), three [spears](compendium/items/spear-xphb.md), [studded leather armor](compendium/items/studded-leather-armor-xphb.md)
- **Languages** Common
- **Challenge** 5
...
***Shield Bash.*** *Strength Saving Throw:* DC 15, one creature within 5 feet that the gladiator can see. *Failure:* 9 (2d4 + 4) Bludgeoning damage. If the target is a Medium or smaller creature, it has the [Prone](compendium/rules/conditions.md#Prone) condition.
