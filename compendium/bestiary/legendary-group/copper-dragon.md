...
- The dragon chooses a point on the ground that it can see within 120 feet of it. Stone spikes sprout from the ground in a 20-foot radius centered on that point. The effect is otherwise identical to the [spike growth](compendium/spells/spike-growth-xphb.md) spell and lasts until the dragon uses this lair action again or until the dragon dies.  
...
At your discretion, a legendary ([adult](compendium/bestiary/dragon/adult-copper-dragon-xmm.md) or [ancient](compendium/bestiary/dragon/ancient-copper-dragon-xmm.md)) copper dragon can use one or both of the following additional lair actions while in its lair:
