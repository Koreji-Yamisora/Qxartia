...
![](compendium/bestiary/monstrosity/token/cockatrice-regent-xmm.webp#token)
...
- **Condition Immunities** [petrified](compendium/rules/conditions.md#Petrified)
- **Languages** —
- **Challenge** 8
