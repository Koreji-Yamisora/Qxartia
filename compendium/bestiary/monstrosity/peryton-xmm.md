...
![](compendium/bestiary/monstrosity/token/peryton-xmm.webp#token)
...
- **Proficiency Bonus** +2
- **Saving Throws** ⏤
- **Skills** [Perception](compendium/rules/skills.md#Perception) +5, [Stealth](compendium/rules/skills.md#Stealth) +3
...
***Talons.*** *Melee Attack Roll:* +5, reach 5 ft. *Hit:* 8 (2d4 + 3) Piercing damage. If the attack reduces a Humanoid target to 0 [Hit Points](compendium/rules/variant-rules/hit-points-xphb.md), the peryton kills the target by removing its heart.
^statblock
