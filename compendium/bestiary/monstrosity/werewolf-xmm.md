...
![](compendium/bestiary/monstrosity/token/werewolf-xmm.webp#token)
...
***Pack Tactics.*** The werewolf has [Advantage](compendium/rules/variant-rules/advantage-xphb.md) on an attack roll against a creature if at least one of the werewolf's allies is within 5 feet of the creature and the ally doesn't have the [Incapacitated](compendium/rules/conditions.md#Incapacitated) condition.
