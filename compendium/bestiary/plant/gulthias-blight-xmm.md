...
![](compendium/bestiary/plant/token/gulthias-blight-xmm.webp#token)
...
***Blight Seeds.*** When it finishes a [Long Rest](compendium/rules/variant-rules/long-rest-xphb.md), the blight expels 1d6 seeds into unoccupied spaces on the ground within 30 feet of itself. After 24 hours, the seeds become creatures under the blight's control. Roll 1d8 for each seed to determine the creature it becomes: on 1-4, [Twig Blight](compendium/bestiary/plant/twig-blight-xmm.md); on 5-6, [Needle Blight](compendium/bestiary/plant/needle-blight-xmm.md); on 7-8, [Vine Blight](compendium/bestiary/plant/vine-blight-xmm.md).
...
***Life-Draining Root.*** *Constitution Saving Throw:* DC 20, one Huge or smaller creature the blight can see within 30 feet. *Failure:* 14 (2d6 + 7) Necrotic damage, and the target has the [Grappled](compendium/rules/conditions.md#Grappled) condition (escape DC 17) from one of six roots. Until the grapple ends, the target has the [Restrained](compendium/rules/conditions.md#Restrained) condition and takes 14 (4d6) Necrotic damage at the start of each of its turns. The target's [Hit Point](compendium/rules/variant-rules/hit-points-xphb.md) maximum decreases by an amount equal to the Necrotic damage taken, and the blight regains [Hit Points](compendium/rules/variant-rules/hit-points-xphb.md) equal to that amount.
^statblock
