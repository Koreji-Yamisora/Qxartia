...
You can use an [Arcane Focus](compendium/items/arcane-focus-xphb.md) as a [Spellcasting Focus](compendium/rules/variant-rules/spellcasting-focus-xphb.md) for your Warlock spells.
