...
The Wizard Features table shows how many spell slots you have to cast your level 1+ spells. You regain all expended slots when you finish a [Long Rest](compendium/rules/variant-rules/long-rest-xphb.md).
...
Whenever you finish a [Long Rest](compendium/rules/variant-rules/long-rest-xphb.md), you can change your list of prepared spells, replacing any of the spells there with spells from your spellbook.
...
You can use an [Arcane Focus](compendium/items/arcane-focus-xphb.md) or your spellbook as a [Spellcasting Focus](compendium/rules/variant-rules/spellcasting-focus-xphb.md) for your Wizard spells.
